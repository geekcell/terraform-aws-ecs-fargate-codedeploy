...
| <a name="input_lb_listener_ssl_policy"></a> [lb\_listener\_ssl\_policy](#input\_lb\_listener\_ssl\_policy) | The SSL policy to use for HTTPS listener. | `string` | `"ELBSecurityPolicy-TLS13-1-2-2021-06"` | no |
...
| <a name="input_lb_test_listener_ssl_policy"></a> [lb\_test\_listener\_ssl\_policy](#input\_lb\_test\_listener\_ssl\_policy) | The SSL policy to use for the test HTTPS listener. | `string` | `"ELBSecurityPolicy-2016-08"` | no |
